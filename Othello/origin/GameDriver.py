...
class GameDriver:
    def __init__(self, p1type="human", p2type="alphadisplaybeta", num_rows=4, num_cols=4, p1_eval_type=0, p1_prune=False, p2_eval_type=0, p2_prune=False, p1_depth=8, p2_depth=8):
